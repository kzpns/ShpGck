namespace ShpGck.CafeCode
{
    ...
    {
        public CCConditionalNotEqual(uint addr, byte val, bool isPtr = false)
        {
        ...
        public CCConditionalNotEqual(uint addr, ushort val, bool isPtr = false)
        {
        ...
        public CCConditionalNotEqual(uint addr, uint val, bool isPtr = false)
        {
        ...
        public CCConditionalNotEqual(uint addr, uint val, ValueSize valSize, bool isPtr = false)
        {
            ValueSize = valSize;
            Address = addr;
            Value = val;
